...
public class LocationUtil {
    ...
    public static boolean checkPointInBoundingBox(LatLng location, Server selectedServer) {
        ...
        LatLng lowerRight = new LatLng(selectedServer.getLowerLeftLatitude(),
                selectedServer.getUpperRightLongitude());*/
        LatLng lowerLeft = new LatLng(43.714161000000004,
                9.124888700000001);
        LatLng upperLeft = new LatLng(47.1049458,9.124888700000001);
        LatLng upperRight = new LatLng(47.1049458,
                13.956236200000001);
        LatLng lowerRight = new LatLng(43.714161000000004,
                13.956236200000001);
