...
public class MetadataRequest extends AsyncTask<String, Integer, GraphMetadata> {
    ...
    protected GraphMetadata doInBackground(String... reqs) {
       ...
       // String u = reqs[0] + prefix + OTPApp.METADATA_LOCATION;
        ...
        metadata.setLowerLeftLatitude(43.714161000000004);
        metadata.setLowerLeftLongitude(9.124888700000001);
        metadata.setUpperRightLatitude(47.1049458);
        metadata.setUpperRightLongitude(13.956236200000001);

        Double centerLat = (metadata.getLowerLeftLatitude()+metadata.getUpperRightLatitude())/2;
        metadata.setCenterLatitude(centerLat);

        Double centerLong = (metadata.getLowerLeftLongitude()+metadata.getUpperRightLongitude())/2;
        metadata.setCenterLongitude(centerLong);
