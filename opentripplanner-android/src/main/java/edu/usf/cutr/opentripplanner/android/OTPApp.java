...
public class OTPApp extends Application {
    ...
    public void setSelectedServer(Server sServer) {
        Server s = new Server();
        // s.setDate(1470306121035l);
        s.setRegion("Nord-Est Italia, Italy");

        s.setBaseURL("http://137.204.75.217:8080/otp");
        s.setBounds("43.714161000000004,9.124888700000001,47.1049458,13.956236200000001");

     /*
        s.setId(17);

        s.setDate(1470306121035l);
        s.setRegion("Bologna Province, Italy");

        s.setBaseURL("http://bologna.vivibus.it/otp");
        s.setBounds("44.3759,10.9492,44.6594,11.7155");  // do extra string processing to set lowerleft and upperright

        s.setCenter("44.4977,11.3436");
...
//		new MetadataRequest(activity).execute("");
    ...
    public Server getSelectedServer() {
        Server s = new Server("http://137.204.75.217:8080/otp",getApplicationContext());
        s.setBounds("43.714161000000004,9.124888700000001,47.1049458,13.956236200000001");
        // s.setDate(1470306121035l);
        /*s.setRegion("Nord-Est Italia, Italy");

        s.setBaseURL("http://192.168.1.4:8080/otp");
